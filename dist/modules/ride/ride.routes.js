...
const rideRequestController = __importStar(require("./rideRequest.controller"));
const rideHistoryController = __importStar(require("./rideHistory.controller"));
const fareController = __importStar(require("./fare.controller"));
const authMiddleware_1 = require("../../middlewares/authMiddleware");
const router = express_1.default.Router();
const authRider = [authMiddleware_1.authenticateJWT, (0, authMiddleware_1.authorizeRoles)("rider")];
